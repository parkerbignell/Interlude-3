...
# Interlude 3 
## Reflection 
The main message of this module is that some forms of computer programming are much more difficult than others. 
## Log
...
On the final instructional day of the course, I did my best to create my own map in NetLogo Web. I thankfully received the link from the Professor Graham on how to properly add in the necessary information and coordinates in order to generate the map he was showing on the board.  
## Ephemera
